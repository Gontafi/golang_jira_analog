...
func (r *IssueRepos) GetById(id int) (models.Issue, error) {
...
func (r *IssueRepos) Create(issue models.Issue) (int, error) {
	var id int
...
func (r *IssueRepos) GetAll() ([]models.Issue, error) {
...
func (r *IssueRepos) Update(issue models.Issue) error {
...
func (r *IssueRepos) Delete(id int) error {
