...
func (r *IssueTypeRepos) GetById(id int) (models.IssueType, error) {
...
func (r *IssueTypeRepos) Create(issueType models.IssueType) (int, error) {
	var id int
...
func (r *IssueTypeRepos) GetAll() ([]models.IssueType, error) {
...
func (r *IssueTypeRepos) Update(issueType models.IssueType) error {
...
func (r *IssueTypeRepos) Delete(id int) error {
