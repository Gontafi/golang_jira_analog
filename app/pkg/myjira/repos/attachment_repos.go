...
func (r *AttachmentRepos) GetByAttachmentID(id int) (models.Attachment, error) {
...
func (r *AttachmentRepos) CreateAttachment(attachment models.Attachment) (int, error) {
	var id int
...
func (r *AttachmentRepos) GetAllAttachments() ([]models.Attachment, error) {
...
func (r *AttachmentRepos) UpdateAttachment(attachment models.Attachment) error {
...
func (r *AttachmentRepos) DeleteAttachment(id int) error {
