...
func (r *TagRepos) GetByTagID(id int) (models.Tag, error) {
	var tag models.Tag
...
func (r *TagRepos) CreateTag(tag models.Tag) (int, error) {
	var id int
...
func (r *TagRepos) GetAllTags() ([]models.Tag, error) {
...
func (r *TagRepos) UpdateTag(tag models.Tag) error {
...
func (r *TagRepos) DeleteTag(id int) error {
